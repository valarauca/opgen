...
// RDRAND--Read Random Number.
	...
	///
	/// 'rdrand r64;' Read a 64-bit random number and store in the destination register.
	RDRAND,
// RDSEED--Read Random SEED.
	...
	///
	/// 'rdseed r64;' Read a 64-bit NIST SP800-90B & C compliant random value and store in the destination register.
	RDSEED,
...
// SYSRET--Return From Fast System Call.
	///
	/// 'sysret;' Return to compatibility mode from fast system call.
	///
	/// 'sysret;' Return to 64-bit mode from fast system call.
	SYSRET,
